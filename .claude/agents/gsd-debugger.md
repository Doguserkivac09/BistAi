...
```bash
INIT=$(node "C:/Users/MspDo/PROJELERİMİZ/BISTAI/.claude/get-shit-done/bin/gsd-tools.cjs" state load)
...
```bash
node "C:/Users/MspDo/PROJELERİMİZ/BISTAI/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs: resolve debug {slug}" --files .planning/debug/resolved/{slug}.md
```
...
```bash
node "C:/Users/MspDo/PROJELERİMİZ/BISTAI/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs: update debug knowledge base with {slug}" --files .planning/debug/knowledge-base.md
```
