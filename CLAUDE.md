...
| `20260602_signal_performance_market.sql` | signal_performance: market kolonu + unique constraint (sembol,signal_type,entry_time,market) | ⚠️ **ÇALIŞTIRILMALI** — US sinyal takibi için ŞART, deploy öncesi/anında |
