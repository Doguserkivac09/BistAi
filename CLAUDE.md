...
| `20260517_signal_tracker.sql` | signal_tracker tablosu (Sinyal Takipçisi) | ⏳ Çalıştırılacak |
| `20260523_future_scores.sql` | future_scores tablosu + RLS (Phase C) | ⏳ Çalıştırılacak |
| `20260603_signal_performance_market.sql` | signal_performance.market kolonu + backfill (BUG-1 fix) | ⏳ Çalıştırılacak |
